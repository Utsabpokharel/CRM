  ...
  <div class="page-bar">
    <div class="page-title-breadcrumb">
      <ol class="breadcrumb page-breadcrumb">
        ...
        <li><a class="parent-item" href="">Expensescategory</a>&nbsp;
          <i class="fa fa-angle-right"></i>
        </li>
        <li class="active">All Expensescategory</li>
      </ol>
    </div>
  </div>
      ...
      <div class="card-header">
        ...
        <div class="card-toolbar">
          ...
          <div class="dropdown dropdown-inline mr-2">
            ...
            <!--end::Dropdown-->
            <!--begin::Button-->
            <a href="{{route('expensescategory.create')}}" class="btn btn-primary font-weight-bolder">
              <span class="svg-icon svg-icon-md">
          ...
          <tbody>
            @foreach($expensescategory as $key=>$expensescategories)
          <tr>
            <td>{{$key+1}}</td>
