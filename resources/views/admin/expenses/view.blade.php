...
@if(!empty($trashed))
@section('page_title','Trashed Expenses')
  ...
  <div class="page-bar">
    <div class="page-title-breadcrumb">
      <ol class="breadcrumb page-breadcrumb">
       ...
       <li><a class="parent-item" href="">Expenses</a>&nbsp;
          <i class="fa fa-angle-right"></i>
        </li>
        <li class="active">{{!empty($trashed) ? 'All Trashed Expenses': 'All Expenses'}}</li>
      </ol>
    </div>
  </div>
        ...
        <div class="card-toolbar">
            ...
            <a href="{{route('expenses.create')}}" class="btn btn-primary font-weight-bolder">
              ...
              <a href="{{route('expenses.view')}}" id=""
                      class="btn btn-warning">
                        View Expenses<i class="fa fa-eye"></i>
               </a>
          @else
            <a href="{{route('expenses.Viewtrashed')}}" id=""
                      class="btn btn-warning">
                        Trashed Expenses  <i class="fa fa-eye"></i>
               </a>
          @endif
              <!--end::Button-->
            </div>
          ...
          <tr>
            ...
            <td class="text-center">
              @if(!empty($trashed))
                  <a class="deleteData" href="javascript::" rel1="{{route('expenses.trashed',$expensess->id)}}">
                    <i class="fa fa-trash text-danger"></i>
                  </a>
                  <hr>
                  <a href="{{route('expenses.restore',$expensess->id)}}">
