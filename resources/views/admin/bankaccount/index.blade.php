	...
	<div class="page-bar">
		<div class="page-title-breadcrumb">
			<ol class="breadcrumb page-breadcrumb">
				...
				<li><a class="parent-item" href="">Bank Account</a>&nbsp;
					<i class="fa fa-angle-right"></i>
				</li>
		...
		<div class="card card-custom">
			<div class="card-header">
				<div class="card-title">
					...
					<h3 class="card-label">Bank Account Table</h3>
				</div>
				<div class="card-toolbar">
					...
					<div class="dropdown dropdown-inline mr-2">
						...
						<!--end::Dropdown-->
						<!--begin::Button-->
						<a href="{{route('bank.create')}}" class="btn btn-primary font-weight-bolder">
							<span class="svg-icon svg-icon-md">
							...
							@if(!empty($trashed))
							<a href="{{route('bank.index')}}" class="btn btn-warning">View Bank Account</a>
							@else
							<a href="{{route('bank.ViewTrash')}}" class="btn btn-warning">View Trashed Bank Account</a>
							@endif
							<!--end::Button-->
						</div>
					</div>
					<div class="card-body">
						<!--begin: Datatable-->
						<table id="bank_table" class="display nowrap table" style="width:100%">
